...
/* const criarObjeto = (obj , key , value) =>{
 obj.key = value
}
let obj = criarObjeto( nome, 'kelly' ,'kinter');
...
const objectKey = student =>{
  let chaves = Object.keys(student);
  for (let keys in chaves) {
  let valor = Object.values(student);
  console.log(`${chaves[keys]}: ${valor[keys]}, indice ${keys}`)
   }
 }
objectKey(student2)
